...
// type DecodeResult<T> = Readonly<
//   [{ issues: Issue[] }, undefined] | [undefined, T]
// >
...
//     decode: (value, context = createDecodeContext()) => {
//       const [err, result] = schema.decode(value, context)
//       return err ? [err, undefined] : success(context, mapper(result))
//     },
//   })
// }
...
// )
// const guardAgainstNaN = refine(
//   "NaN guard",
//   (value: number) => !Number.isNaN(value),
// )
// export const number = guardAgainstNaN(numberOrNaN)
...
// const mapDate = map((value: string | number | Date) => new Date(value))
// const isValidDate = (date: Date) => !Number.isNaN(date.valueOf())
